...
class InquiryControllerTest extends IntegrationBase {
    ...
    void setUp() {
        ...
        userRepository.save(User.builder().email("seller").seller(seller).build());
    ...
    void findInquires() throws Exception {
        ...
        Inquiry inquiry2 = Inquiry.builder().product(product1).isSecret(true).user(user2).content("content2").build();
        Inquiry inquiry3 = Inquiry.builder().product(product1).isSecret(false).user(user3).content("content3").build();
    ...
    void deleteInquiry() throws Exception {
        Inquiry inquiry1 = Inquiry.builder().product(product1).isSecret(true).user(user1).content("content1").build();
        Inquiry saveInquiry = inquiryRepository.save(inquiry1);
